...
public class ExternalHalfWall4 extends AutoDrawnableObject {

	private int startList = 11;

	public ExternalHalfWall4(GL2 gl) {
		super(gl);
		initData();
	}
