...
public class LeftChapel extends AutoDrawnableObject {
	...
	private void initData() {
		...
		double[] normal = GeometryUtils.calculateNormal(rect[0], rect[1],
				rect[2]);
		double abertura[][] = createPortalVertices(0.5f);
	...
	public void selfDraw(GL2 gl) {
		...
		gl.glTranslatef(12.35f, -22f, 0.0f);
