...
public class ExternalHalfWall2 extends AutoDrawnableObject{
	
	private int startList = 9;
	
	public ExternalHalfWall2(GL2 gl) {
		super(gl);
		initData();
	}
