...
public class ExternalHalfWall3 extends AutoDrawnableObject {

	private int startList = 10;

	public ExternalHalfWall3(GL2 gl) {
		super(gl);
		initData();
	}
